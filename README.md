[![Run App Nguyen, Avery](https://github.com/avxryn/GithubActions/actions/workflows/run-app.yml/badge.svg)](https://github.com/avxryn/GithubActions/actions/workflows/run-app.yml)
